...
<div class="page">
	{#if draft}
		...
		<!-- Все восемь разделов сразу, колонками: в один свиток они давали
			 страницу примерно на 1700px при окне в 720, а в две панели оставляли
			 пустой полэкрана справа. -->
